...
class Game extends Component {
    ...
    handleClick(name, index) {
        if (this.state.openedCards.length === 2 && this.state.openedCards[0].index !== index) {
            setTimeout(() => {
                this.checkMatch()
            }, 750)
        } else {
    ...
    checkMatch() {
        ...
        if ((this.state.openedCards[0].name === this.state.openedCards[1].name) && (this.state.openedCards[0].index !== this.state.openedCards[1].index)) {
            ...
            const matchedCards = currentMatches.concat(finalDeck[this.state.openedCards[1].index].name);
            ...
            <div>
                <div className="header">
                    ...
                    <div className="header-right">
                        <button className="button" onClick={() => { this.start() }}>NEW GAME</button>
                    </div>
                </div>
